export const tosContent = {
  agreement: {
    ...
    intro: `
      We are zkkva ("Company," "we," "us," "our").
      We operate the mobile application CalVision (the "App"), as well as any other related products and services 
      that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
    `,
    description: `
      CalVision simplifies calorie tracking and fitness goals with cutting-edge AI technology. Snap a photo of your 
      meal, and our app instantly calculates calories and macros, making health management effortless. Whether you're 
      aiming to lose weight, gain muscle, or maintain a balanced diet, CalVision is your perfect companion. Stay in 
      control of your progress with intuitive tools, personalized insights, and a seamless user experience. Transform 
      the way you manage your nutrition today!
    `,
    contact: `
      You can contact us by email at help@calvision.app or by mail to ________.
    `,
    legalAgreement: `
      These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an 
      entity ("you"), and zkkva, concerning your access to and use of the Services. You agree that by accessing the 
  ...
  userRepresentations: {
    ...
    description: `
      ...
      registration information as necessary; (3) you have the legal capacity and you agree to comply with these Legal Terms; (4) you are not under the age of
      ...
      illegal or unauthorized purpose; and (8) your use of the Services will not
  ...
  purchasesAndPayment: {
    ...
    description: `
      ...
      billing account for purchases made via the Services. Sales tax will be added
  ...
  subscriptions: {
    ...
    cancellation: `
      ...
      time by logging into your account. Your cancellation will take effect at the end
      of the current paid term. If you have any questions or are unsatisfied with our
      Services, please email us at help@calvision.app.
    `,
    feeChanges: `
  ...
  mobileApplicationLicense: {
    title: '7. Mobile Application License',
    description: `
      ...
      conditions of this mobile application license contained in these Legal Terms.
    ...
    block: `
      ...
      whatsoever with respect to the App; (4) you represent and warrant that (i)
  ...
  privacyPolicy: {
    ...
    description: `
      ...
      Policy: http://www.calvision.app/privacy. By using the Services, you agree
      to be bound by our Privacy Policy, which is incorporated into these Legal
      Terms. Please be advised the Services are hosted in Canada. If you access
      ...
      from applicable laws in Canada, then through your continued use of the
      Services, you are transferring your data to Canada, and you expressly
      consent to have your data transferred to and processed in Canada. Further,
  ...
  governingLaw: {
    ...
    description: `
      ...
      Canada. zkkva and yourself irrevocably consent that the courts of Canada
  ...
  limitationsOfLiability: {
    ...
    description: `
      ...
      TO USDURING THE TWO (2) MONTH PERIOD PRIOR TO ANY CAUSE
  ...
  userData: {
    ...
    use of the Services. If needed I will sell your user data. Although we perform regular routine backups of data,
