    ...
    return (
        <section className="relative w-full min-h-screen mx-auto pb-8 pl-8 pr-8">
            ...
            <div className="flex flex-col items-center">
                ...
                <FeatureCard title="How does CalVision work?" description="CalVision simplifies calorie tracking with cutting-edge AI. Just snap a photo of your meal, and our app with instantly analyze the image to calculate the calories and macros. Whether you're looking to lose weight, gain muscle, or maintain, CalVision helps you stay on track effortlessly."/>
                <FeatureCard title="Is the camera tracking accurate?" description="CalVision's calorie tracking provides an estimated accuracy of around 85%-90% for most common meals. This high accuracy is achieved through advanced AI analysis of visual and contextual data from your meal photos. While the results are reliable for general tracking, factors like lighting, photo quality, and complex dishes may slightly affect precision. To improve accuracy, users can manually adjust portion sizes or provide additional details when needed."/>
                <FeatureCard title="How does CalVision set my goals?" description="CalVision sets your goals by using the biometric information you provide during onboarding, such as your sex, height, current weight, target weight, and activity level. The app calculates your daily calorie and macronutrient requirements based on scientifically-backed formulas and adjusts them to fit your specific needs. Whether your aim is to lose weight, gain muscle, or maintain your current physique, CalVision provides personalized targets to help you reach your fitness goals efficiently." />
